...
<code> <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%> </code>
  <%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<div class="beanlist-wrap">
		<div class="title">
		<h1 style="font-size: 70px;">원두</h1>
		</div>
		<div class="bean-image">
		<img src="/resources/img/원두.webp">
		</div>
...
<nav aria-label="...">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="/product/list/원두?curpage=${pt.curPage <= 1? 1: pt.curPage-1}">previous</a>
    </li>
    
    <c:forEach begin="${pt.beginPageNum}" end="${pt.finishPageNum}" var="page">
       <c:if test="${page == pt.curPage}">
           <li class="page-item active" aria-current="page">
               <a class="page-link" href="/product/list/원두?curpage=${pt.curPage}">${page}</a>
          </li>
       </c:if>
       
       <c:if test="${page != pt.curPage}">
            <li class="page-item">
            <a class="page-link" href="/product/list/원두?curpage=${page}">${page}</a></li>
       </c:if>
    ...
    <li class="page-item">
      <a class="page-link" href="/product/list/원두?curpage=${pt.curPage >= pt.totalPage? pt.totalPage : pt.curPage+1}">Next</a>
    </li>
  </ul>
</nav>
