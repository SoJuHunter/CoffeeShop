...
<%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<div class="title">
		<h1 style="font-size: 70px;">핸드드립</h1>
		</div>
		<div class="hand-image">
		<img src="/resources/img/핸드드립.jpg">
		</div>
...
<nav aria-label="...">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="/product/list/핸드드립?curpage=${pt.curPage <= 1? 1: pt.curPage-1}">Previous</a>
    </li>
    
    <c:forEach begin="${pt.beginPageNum}" end="${pt.finishPageNum}" var="page">
       <c:if test="${page == pt.curPage}">
           <li class="page-item active" aria-current="page">
               <a class="page-link" href="/product/list/핸드드립?curpage=${pt.curPage}">${page}</a>
          </li>
       </c:if>
       
       <c:if test="${page != pt.curPage}">
            <li class="page-item">
            <a class="page-link" href="/product/list/핸드드립?curpage=${page}">${page}</a></li>
       </c:if>
    ...
    <li class="page-item">
      <a class="page-link" href="/product/list/핸드드립?curpage=${pt.curPage >= pt.totalPage? pt.totalPage : pt.curPage+1}">Next</a>
    </li>
  </ul>
</nav>
