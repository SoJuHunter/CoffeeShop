		...
		<div class="card-body">
			<form action="/user/update" method="post" class="form-signin">
				...
				<input type="text" name="uPhone" id="uPhone" value="${uDto.uPhone}"
					class="form-control" placeholder="-없이 입력하세요."><br>
				<br> <br />
				...
				<button type="submit" id="btn-Yes"
					class="btn btn-lg btn-primary btn-block" onclick="submit()">정보수정</button>
				<br>
			</form>

			<button id="btn_cancle" class="btn btn-lg btn-primary btn-block"
				type="button" onclick="location.href = '/' ">수정취소</button>
