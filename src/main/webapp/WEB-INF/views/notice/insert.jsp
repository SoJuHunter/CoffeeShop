...
<body>
	...
	<table>
			...
			<tr>
				<td>제목</td>
				<td><input id=nTitle name="nTitle" required></td>
			</tr>
	
			<tr>
				<td>문의 내용</td>
				<td><textarea row="10" id="nContent" name="nContent" required></textarea></td>
			</tr>
		...
		<tr >
			...
			<td><input type="button" onclick="location.assign('/notice/list')" value="목록 보기"></td>
		</tr>
